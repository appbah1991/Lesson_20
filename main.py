...
req = str(input('Введите текст поискового запроса, например "java": ')).replace(' ', '+')
...
# принтим получившийся словарь
print(dict_of_news_all)

# сохраняем словарь в файл
with open('list_of_news.txt', 'w', encoding='utf8') as f:
    for listitem in dict_of_news_all:
        f.write('%s\n' % listitem)
